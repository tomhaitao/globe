...
(function (window, document) {
    ...
    Missile.prototype = {
        ...
        buildCone: function () {
            ...
            this.cone.count = floatArray.length;
        ...
        buildMissile: function () {
            ...
            var itemsBuffers = new FLOAT32_ARRAY(self.count * 800);
            //初始化1000个导弹
            for (var i = 0; i < self.count; i++) {
                var vertex = itemsBuffers.subarray(i * 800, (i + 1) * 800);
                self.items.push(new MissileItem(vertex));
            }

            self.missile.buffer = makeVertexBuffer(context, itemsBuffers);
         ...
         * @returns {Missile}
         */
        launch: function (source_coord, target_coord, color, sacle, angle) {
            var missile = this.getFreeMissile();
            missile.launch(source_coord, target_coord, color, sacle, angle);
    ...
    MissileItem.prototype = {
        ...
        launch: function (source_coord, target_coord, sacle, angle, color) {
            var self = this;

            vec3.copy(self.source_coord, source_coord);
